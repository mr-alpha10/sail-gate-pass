...
export default function ResetPasswordClient() {
  ...
  async function handleResendOTP() {
    ...
    try {
      ...
      console.log("==================================================")
      console.log("📧 MOCK EMAIL SENT (RESEND)")
      console.log("==================================================")
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="max-w-md mx-auto md:mx-0">
              ...
              <form action={handleResetPassword} className="space-y-6">
                <div>
                  <div className="flex items-center justify-between mb-2">
                    ...
                    >
                      {resendLoading && <RefreshCw className="w-3 h-3 mr-1 animate-spin" />}
                      Resend OTP
                    </button>
                  </div>
                  <Input
                  ...
                  />
                  <p className="text-xs text-gray-500 mt-1">Check browser console (F12) for OTP in demo mode</p>
                </div>
              ...
              <div className="text-center mt-6">
                <Link href="/forgot-password" className="text-[#6366f1] hover:underline text-sm">
                  Back to email entry
                </Link>
              </div>
            </div>
            ...
            <div className="hidden md:block">
              <div className="relative">
                <img
                  src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Screenshot%202025-06-08%20160312-evSc8rynSV9VshOSgxKXWu7uEY82kb.png"
